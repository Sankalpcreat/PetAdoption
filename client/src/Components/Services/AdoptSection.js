...
const AdoptSection = () => {
  ...
  return (
    <section className="adopt-section">
      ...
      <p>
        Welcome to our pet adoption program! Adopting a pet is a wonderful way to bring
      ...
      <p>
        Adopting a pet comes with responsibilities, including feeding, grooming, regular
        exercise, and providing medical care.
      </p>
